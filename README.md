...
```bash
poetry run pcd compile <directory | file> # you need to specify a directory or a .py file
```

E.g.,

```bash
poetry run pcd compile examples/01_example_variables.py # `example/__pycache__/01_example_variables.cpython-310.pyc` will be created
```

## Decompile

```bash
poetry run pcd decompile <pyc-file> # you need to specify a .pyc file
```

E.g.,

```bash
poetry run pcd decompile example/__pycache__/01_example_variables.cpython-310.pyc # decompiled code will be printed
```

```bash
poetry run pcd decompile example/__pycache__/01_example_variables.cpython-310.pyc -o example/__pycache__/01_example_variables.cpython-310.py # decompiled code will be written to `example/__pycache__/01_example_variables.cpython-310.py`
```

## Examples

You can find examples in `examples` directory or below (decompiled code is generated by `pcd`).
